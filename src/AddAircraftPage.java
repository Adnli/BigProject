...
public class AddAircraftPage extends JPanel {
    ...
    public AddAircraftPage(ClientFrame parent){
        this.parent=parent;
        setSize(500,500);
        setLayout(null);
        ...
        confirm.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                Aircraft aircraft = new Aircraft(0,name,model,business_class_capacity,econom_class_capacity);
        ...
        back.addActionListener(new ActionListener() {
            @Override
            public void actionPerformed(ActionEvent e) {
                parent.getAddAircraftPage().setVisible(false);
